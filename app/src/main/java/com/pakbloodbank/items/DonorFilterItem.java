...
public class DonorFilterItem {
    private String blood_group, latitude, longitude, radius, order_by, city, state, country, added_by, donor_type;
    ...
    public DonorFilterItem getFilterWith(String blood_group, String latitude, String longitude, String radius, String order_by, String city, String state, String country, String added_by, String donor_type) {
        ...
        this.donor_type = donor_type != null ? donor_type : "";
        this.isEdit=false;
        return this;
    }
