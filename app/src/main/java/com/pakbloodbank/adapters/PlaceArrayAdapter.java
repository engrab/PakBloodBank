...
public class PlaceArrayAdapter extends ArrayAdapter<AutocompletePrediction> implements Filterable {
     ...
     */
    public PlaceArrayAdapter(Context context, RectangularBounds bounds) {
